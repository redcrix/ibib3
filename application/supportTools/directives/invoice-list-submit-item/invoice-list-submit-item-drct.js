(function () {
    var invoiceListSubmitItem = function () {
        return {
            restrict: 'E',
            replace: true,
            scope: {
            ...
            link: function (scope, ele, attr, controllers) {
              console.log('submitted screen----: ',scope.item);
    ...
    invoiceListSubmitItem.$inject = [];
    projectCostByte.directive('invoiceListSubmitItem', invoiceListSubmitItem)
})();
