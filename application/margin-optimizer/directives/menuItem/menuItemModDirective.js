(function () {
    ...
    detailedmenuitemsales.$inject = ['$ionicScrollDelegate', 'MarginOptimizerServiceOne'];

    function detailedmenuitemsales($ionicScrollDelegate, MarginOptimizerServiceOne) {
        return {
            restrict: 'E',
            templateUrl: 'application/margin-optimizer/directives/menuItem/menuItemModDirective.html',
            scope: {
                item: '=',
                getdataoninit: '=',
                ifeven: '=',
            ...
            link: function (scope, element, attribute) {
                ...
                function fetchDetailedModsData(menuitem_id) {
                    ...
                    MarginOptimizerServiceOne.fetchDetailedModsData(fetchDetailedModsDataResponseHandler, menuitem_id);
                }
