(function (window) {
    ...
    c3_chart_internal_fn.generateEventRectsForSingleX = function (eventRectEnter) {
        ...
        eventRectEnter.append("rect")
            .attr("class", $$.classEvent.bind($$))
            .style("cursor", config.data_selection_enabled && config.data_selection_grouped ? "auto" : null)
                ...
                $$.main.selectAll('.' + CLASS.shape + '-' + index)
                    .each(function () {
                        ...
                        if (config.data_selection_enabled) {
                            eventRect.style('cursor', config.data_selection_grouped ? 'auto' : null);
                        }
                        if (!config.tooltip_grouped) {
                            $$.hideXGridFocus();
                            $$.hideTooltip();
        ...
        eventRectEnter.append('rect')
            ...
            .on('mousemove', function () {
                ...
                if ($$.isBarType(closest.id) || $$.dist(closest, mouse) < 100) {
                    $$.svg.select('.' + CLASS.eventRect).style('cursor', 'auto');
                    if (!$$.mouseover) {
    ...
    c3_chart_internal_fn.updateTargetsForLine = function (targets) {
        ...
        mainLineEnter.append('g')
            ...
            .style("cursor", function (d) { return config.data_selection_isselectable(d) ? "auto" : null; });
    ...
    c3_chart_internal_fn.redrawArc = function (duration, durationForExit, withTransform) {
        ...
        mainArc.enter().append('path')
            ...
            .style("cursor", function (d) { return config.interaction_enabled && config.data_selection_isselectable(d) ? "auto" : null; })
            .style("opacity", 0)
            .each(function (d) {
                if ($$.isGaugeType(d.data)) {
